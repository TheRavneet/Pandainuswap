...
import "./interfaces/IEiFiMigrator.sol";
import "./interfaces/V1/IUniswapV1Factory.sol";
import "./interfaces/V1/IUniswapV1Exchange.sol";
import "./interfaces/IEiFiRouter01.sol";
import "./interfaces/IERC20.sol";

contract EiFiMigrator is IEiFiMigrator {
    IUniswapV1Factory immutable factoryV1;
    IEiFiRouter01 immutable router;

    constructor(address _factoryV1, address _router) {
        factoryV1 = IUniswapV1Factory(_factoryV1);
        router = IEiFiRouter01(_router);
    }
    ...
    function migrate(
        ...
        (uint256 amountETHV1, uint256 amountTokenV1) = exchangeV1
            .removeLiquidity(liquidityV1, 1, 1, uint256(-1));
